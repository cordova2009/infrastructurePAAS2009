...
http请求方式: post
    ...
    http://IP:PORT/if/capitalManage/queryProjectPaymentAccount
...
正常时的返回JSON数据包示例：
    ...
    {
        "errcode":0,"errmsg":"查询用户工程款帐户详情成功",
        "account":{
            "accountId":"210029328478272",
            "remainingSum":2000,
            "frozenSum":2000,
...
错误时的JSON数据包示例：
    ...
    {"errcode":10000,"errmsg":"查询用户工程款帐户详情，其它错误"}
...
投标人收到工程付款后,可发起工程款提现申请,平台方审核通过后，向用户的开户行转账，转账成功后，并登记转账凭证给用户查阅。
...
http请求方式: post
    ...
    http://IP:PORT/if/capitalManage/projectPaymentWithdrawalsApply
...
http请求方式: post
    ...
    http://IP:PORT/if/capitalManage/queryProjectPaymentWithdrawalsApplyList
...
正常时的返回JSON数据包示例：
    ...
    {
        "errcode":0,"errmsg":"查询工程款申请提现记录成功",
        "list":{
            "createTime":"2015-10-10 10:00:00",
            "amount":"2000.00",
            "handingCharge":"20.00",
...
错误时的JSON数据包示例：
    ...
    {"errcode":10000,"errmsg":"查询工程款申请提现记录失败，其它错误"}
