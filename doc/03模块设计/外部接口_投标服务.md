...
http请求方式: post
    ...
    http://ip:port/gw/bid/queryMyBidList
...
http请求方式: post
    ...
    http://ip:port/gw/bid/evaluateBider
...
前置条件：用户必须有投标资质
    ...
    http://ip:port/gw/bid/queryBidderInfo
...
前置条件：用户必须有投标资质
    ...
    http://ip:port/gw/bid/saveBidInfo
...
前置条件：用户必须有投标资质
    ...
    http://ip:port/gw/bid/queryBidInfo
...
前置条件：用户先调用保存投标信息接口
    ...
    http://ip:port/gw/bid/queryTenderBond
