...
POST数据格式：JSON

    {
        ...
        "body":{   
            "token":"54365769",
            "smsCode":"324545",
            "oldLoginPassword":"231EEREWQR",
            "newLoginPassword":"3425"
        }
    }
...
POST数据格式：JSON

    {
    	...
    	"body":{
            "token":"54365769",
	        "smsCode":"324545",
            "oldTradePassword":"231EEREWQR",
	        "newTradePassword":"3425"
    	}
    }
...
POST数据格式：JSON

    {
	    ...
	    "body":{
            ...
            "oldMobileNum":"13657253221",
    	    "newMobileNum":"13657265432"
	   }
    }
...
------|------|-------
token|是|用户令牌
firstSmsCode|是|第一步短信验证码
secondSmsCode|是|第二步短信验证码
