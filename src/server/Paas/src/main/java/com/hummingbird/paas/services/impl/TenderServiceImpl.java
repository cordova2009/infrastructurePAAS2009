...
public class TenderServiceImpl implements TenderService {
	...
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class, value = "txManager")
	public void evaluateBidder(EvaluateBidderBodyVO body, User user) throws MaAccountException {
		ProjectInfo project = projectInfoDao.selectByObjectId(body.getObjectId()) == null ? null
				: projectInfoDao.selectByObjectId(body.getObjectId()).get(0);
		if (project == null) {
			if (log.isDebugEnabled()) {
