...
//}
public class BiddeeBaseInfoCheck {
	...
	/**
	 * @param biddee_id the biddee_id to set
	 */
	...
	public String toString() {
		return "BiddeeBaseInfoCheck [biddee_id=" + biddee_id + ", company_name=" + company_name + ", short_name="
