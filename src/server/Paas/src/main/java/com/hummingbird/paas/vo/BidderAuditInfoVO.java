...
//}
public class BidderAuditInfoVO extends AppBaseVO implements Decidable {
	
	private BidderAuditBodyInfo  body;

	/**
	 * @return the body
	 */
	public BidderAuditBodyInfo getBody() {
		return body;
	}
	 ...
	 */
	public void setBody(BidderAuditBodyInfo body) {
		this.body = body;
	}
	...
	public String toString() {
		return "BidderAuditInfoVO [body=" + body + "]";
	}
