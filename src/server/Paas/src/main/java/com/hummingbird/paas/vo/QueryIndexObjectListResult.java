...
//}]
  ...
  protected String projectExpectPeriod;
	/**
	 * @return the objectId
	 */
	...
	public String toString() {
		return "QueryObjectProjectInfoResult [objectId=" + objectId + ", objectName=" + objectName
				+ ", evaluationAmount=" + evaluationAmount + ", companyShortName=" + companyShortName
				+ ", creditRating=" + creditRating + ", objectPredictStartTime=" + objectPredictStartTime
