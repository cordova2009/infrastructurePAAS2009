...
public class QueryObjectDetailConstructionInfo {
    private String constructionProveType;
    private String landUseCertificateNo;
    private String landUseCertificateEndDate;
    private String landUseCertificateUrl;
    private String constructionLandUsePermitNo;
    private String constructionLandUsePermitEndDate;
    private String constructionLandUsePermitUrl;
    private String buildingPermitNo;
    private String buildingPermitEndDate;
    private String buildingPermitPicUrl;
    private String letterOfAcceptanceUrl;
    private String buildingConstructPermitNo;
    private String buildingConstructPermitEndDate;
    private String buildingConstructPermitUrl;
	...
	public String getBuildingPermitPicUrl() {
		return buildingPermitPicUrl;
	}
	public void setBuildingPermitPicUrl(String buildingPermitPicUrl) {
		this.buildingPermitPicUrl = buildingPermitPicUrl;
	}
	...
	public String toString() {
		return "QueryObjectDetailConstructionInfo [constructionProveType=" + constructionProveType
				+ ", landUseCertificateNo=" + landUseCertificateNo + ", landUseCertificateEndDate="
				+ landUseCertificateEndDate + ", landUseCertificateUrl=" + landUseCertificateUrl
				+ ", constructionLandUsePermitNo=" + constructionLandUsePermitNo + ", constructionLandUsePermitEndDate="
				+ constructionLandUsePermitEndDate + ", constructionLandUsePermitUrl=" + constructionLandUsePermitUrl
				+ ", buildingPermitNo=" + buildingPermitNo + ", buildingPermitEndDate=" + buildingPermitEndDate
				+ ", buildingPermitPicUrl=" + buildingPermitPicUrl + ", letterOfAcceptanceUrl=" + letterOfAcceptanceUrl
				+ ", buildingConstructPermitNo=" + buildingConstructPermitNo + ", buildingConstructPermitEndDate="
				+ buildingConstructPermitEndDate + ", buildingConstructPermitUrl=" + buildingConstructPermitUrl + "]";
	}
