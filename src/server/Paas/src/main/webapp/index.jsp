...
<html>
  ...
  <body>
	...
	<tr>
		...
		<td><input  value="保存招标人开户行信息接口"  onclick='setbinding("/myBiddee/authInfo/saveBankInfo_apply","   {    \"app\":{        \"appId\":\"zjhtwallet\",        \"timeStamp\":\"TIMESTAMP\",         \"nonce\":\"NONCE\",        \"signature\":\"SIGNATURE\"    },            \"body\":    {        \"token\":\"USER_TOKEN\",           \"bankInfo\":{             \"bank\":\"招商银行深圳支行\",            \"accountId\":\"1234567812345678\",            \"accountName\":\"深圳麦圈互动技术有限公司\"        }    }}   ")'  type="button" ></td>
	...
	<tr>
		...
		<td><input  value="保存投标人开户行信息接口"  onclick='setbinding("/myBidder/authInfo/saveBankInfo_apply","   {    \"app\":{        \"appId\":\"zjhtwallet\",        \"timeStamp\":\"TIMESTAMP\",         \"nonce\":\"NONCE\",        \"signature\":\"SIGNATURE\"    },            \"body\":    {        \"token\":\"USER_TOKEN\",           \"bankInfo\":{             \"bank\":\"招商银行深圳支行\",            \"accountId\":\"1234567812345678\",            \"accountName\":\"深圳麦圈互动技术有限公司\"        }    }}   ")'  type="button" ></td>
	...
	<tr><td colspan="2">招标人管理</td></tr>
	<tr>
		<td><input  value="查询我的招标人认证信息接口"  onclick='setbinding("/myBiddee/authInfo/getAuthInfo","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\"	}	}")'  type="button" ></td>
		<td><input  value="查询保存的招标人基本信息接口"  onclick='setbinding("/myBiddee/authInfo/getBaseInfo_apply","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\"	}	}")'  type="button" ></td>
		<td><input  value="保存招标人基本信息接口"  onclick='setbinding("/myBiddee/authInfo/saveBaseInfo_apply","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},\"body\":{\"token\":\"12345\",\"baseInfo\":{\"logoUrl\":\"LOGO_IMAGE_URL\"\"companyName\":\"深圳蜂鸟娱乐技术有限公司\",\"shortName\":\"蜂鸟娱乐\",\"description\":\"公司简介\",\"registeredCapital\":\"3000万\",\"telephone\":\"87113242\",\"email\":\"mzd@qq.com\"}}}")'  type="button" ></td>
		<td><input  value="查询保存的招标人法人信息接口"  onclick='setbinding("/myBiddee/authInfo/getLegalPersonInfo_apply","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\"	}	}")'  type="button" ></td>
		<td><input  value="保存招标人法人信息接口"  onclick='setbinding("/myBiddee/authInfo/saveLegalPersonInfo_apply","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},\"body\":{	\"token\":\"12345\",\"legalPerson\":{	\"name\":\"张三\",\"idCard\":\"420923199205049230121\",\"idCardfrontUrl\":\"法人身份证正面地址\",\"idCardBackUrl\":\"法人身份证反面地址\",\"authorityBookUrl\":\"http://12.com/ewvce43\"}}}")'  type="button" ></td>
		<td><input  value="查询保存的招标人法人信息接口"  onclick='setbinding("/myBiddee/authInfo/saveRegisteredInfo","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\"	}	}")'  type="button" ></td>
	</tr>
	<tr>
		<td><input  value="保存招标人公司注册信息接口"  onclick='setbinding("/myBiddee/authInfo/saveRegisteredInfo","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},\"body\":{\"token\":\"12345\",\"registeredInfo\":{\"businessLicenseNum\":\"bl43566\",\"businessLicenseUrl\":\"BUSINESS_LICENSE_URL\",\"taxRegistrationNum\":\"tr788776\",\"taxRegistrationUrl\":\"TAX_REGISTRATION_URL\",\"organizationCodeNum\":\"oc1234\",\"organizationCodeUrl\":\"ORGANIZATION_CODE_URL\"\"businessScope\":\"经营范围\",\"regTime\":\"2014-04-05\",\"businessLicenseExpireTime\":\"10年\",\"address\":\"东风东路111号\",\"businessLicenseType\":\"OLD\",\"newBusinessLicenseNum\":\"\",\"newBusinessLicenseUrl\":\"\",}}}")'  type="button" ></td>
		<td><input  value="查询保存的招标人开户行信息接口"  onclick='setbinding("/myBiddee/authInfo/getRegisteredInfo_apply","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\"	}	}")'  type="button" ></td>
		<td><input  value="保存招标人开户行信息接口"  onclick='setbinding("/myBiddee/authInfo/saveRegisteredInfo","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},\"body\":{\"token\":\"12345\",\"bankInfo\":{\"bank\":\"招商银行深圳支行\",\"accountId\":\"1234567812345678\",\"accountName\":\"深圳麦圈互动技术有限公司\"}}}")'  type="button" ></td>
		<td><input  value="提交招标人认证申请接口"  onclick='setbinding("/myBiddee/authInfo/applay","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\"	}	}")'  type="button" ></td>
		<td><input  value="查询招标人认证申请详情"  onclick='setbinding("/myBiddee/authInfo/getApplication","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\"	}	}")'  type="button" ></td>
	</tr>
	<tr>
		<td><input  value="查询项目已付款详情接口"  onclick='setbinding("/myPayment/queryPaidAmountDetail","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\",  \"objectId\":\"BH2015082135656\" 	}	}")'  type="button" ></td>
		<td><input  value="查询项目应付款详情接口"  onclick='setbinding("/myPayment/queryWillPayAmountDetail","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\",  \"objectId\":\"BH2015082135656\" 	}	}")'  type="button" ></td>
		<td><input  value="查询我的招标项目付款情况接口"  onclick='setbinding("/myPayment/queryMyPaymentList","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},	\"body\":{	\"token\":\"12345\" 	}	}")'  type="button" ></td>
		<td><input  value=""  onclick='setbinding("/member/queryMemberInfo","")'  type="button" ></td>
		<td><input  value=""  onclick='setbinding("/member/queryMemberInfo","")'  type="button" ></td>
	</tr>
	...
	<tr>
		...
		<td><input type="button"  value="解冻施工保证金"  onclick='setbinding("/capitalManage/unfreezeBond","{\"app\":{\"appId\":\"paas\",\"timeStamp\":\"TIMESTAMP\",  \"nonce\":\"NONCE\", \"signature\":\"21aa0011472249b4292e81504f3917bd\"  }, \"body\":{\"token\":\"96c5f0e5e3c52fa0fc632aaa30d4fb85\",\"orderId\":\"FREEZEBOND_ORDER_ID\",\"remark\:\"解冻撮合担保金成功\"}}")'></td>
