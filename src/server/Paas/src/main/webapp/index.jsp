...
<html>
  ...
  <body>
	...
	<tr>
		...
		<td><input  value="保存招标项目工程施工证明接口"  onclick='setbinding("/tender/saveObjectConstructionInfo","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },                \"body\":        {            \"token\":\"45678u5\",            \"objectId\":\"BH2015082135656\",            \"constructionProveType\":\"施工证明类型\",            \"landUseCertificateNo\":\"BH2015110100123\",            \"landUseCertificateEndDate\":\"2015-03-28\",            \"landUseCertificateUrl\":\"URL\",            \"constructionLandUsePermitNo\":\"BH2015110200564\",            \"constructionLandUsePermitEndDate\":\"2015-03-28\",            \"constructionLandUsePermitUrl\":\"URL\",            \"buildingPermitNo\":\"BH2015091800267\",            \"buildingPermitEndDate\":\"2015-03-28\",            \"buildingPermitUrl\":\"URL\",            \"letterOfAcceptanceUrl\":\"URL\",            \"buildingConstructPermitNo\":\"BH2015080400897\",            \"buildingConstructPermitEndDate\":\"2015-03-28\",            \"buildingConstructPermitUrl\":\"URL\"        }    }")'  type="button" ></td>
		<td><input  value="查询未完成招标项目资质要求接口"  onclick='setbinding("/tender/queryObjectCertificationInfo","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },                \"body\":        {       \"token\":\"erwet5\",       \"objectId\":\"BH20151102035656\"    }    }")'  type="button" ></td>
	...
	<tr>
		...
		<td><input  value="保存招标评标方式接口"  onclick='setbinding("/tender/saveBidEvaluationTypeInfo","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },                \"body\":        {            \"token\":\"09fdjg85\",            \"objectId\":\"BH2015082135656\",                \"bidEvaluationType\":\"QLT\",            \"bidEvaluationSite\":\"技术标评标地点\",            \"bidWinnerDetermineWay\":\"ORV\",            \"voteWinWay\":\"SMP\"     }     }")'  type="button" ></td>
