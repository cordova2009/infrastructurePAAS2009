...
<html>
  ...
  <body>
	...
	<tr>
		...
		<td><input  value="审核发布信息接口"  onclick='setbinding("/userInformation/auditUserInformation"," {    \"app\":{        \"appId\":\"zjhtwallet\",        \"timeStamp\":\"TIMESTAMP\",         \"nonce\":\"NONCE\",        \"signature\":\"SIGNATURE\"    },    \"body\":{        \"token\":\"12345\",        \"informationId\":8,        \"status\":\"OK#\"    }}  ")'  type="button" ></td>	
		<td><input  value="首页查询发布信息列表"  onclick='setbinding("/userInformation/queryUserInformationIndexPage"," {    \"app\":{        \"appId\":\"zjhtwallet\",        \"timeStamp\":\"TIMESTAMP\",         \"nonce\":\"NONCE\",        \"signature\":\"SIGNATURE\"    },    \"body\":{ \"pageIndex\":1,  \"pageSize\":10,  \"status\":\"OK#\",\"keywords\":[\"1\"]    }}  ")'  type="button" ></td>	
		</tr>
	...
	<tr>
		...
		<td><input  value="保存招标人开户行信息接口"  onclick='setbinding("/myBiddee/authInfo/saveBankInfo","   {    \"app\":{        \"appId\":\"zjhtwallet\",        \"timeStamp\":\"TIMESTAMP\",         \"nonce\":\"NONCE\",        \"signature\":\"SIGNATURE\"    },            \"body\":    {        \"token\":\"USER_TOKEN\",           \"bankInfo\":{             \"bank\":\"招商银行深圳支行\",            \"accountId\":\"1234567812345678\",            \"accountName\":\"深圳麦圈互动技术有限公司\" ,\"address\":\"北京八大胡同\",\"taxNo\":\"657474\",\"telephone\":\"020-12345678\"       }    }}   ")'  type="button" ></td>
	...
	<tr>
		...
		<td><input  value="保存投标人开户行信息接口"  onclick='setbinding("/myBidder/authInfo/saveBankInfo","   {    \"app\":{        \"appId\":\"zjhtwallet\",        \"timeStamp\":\"TIMESTAMP\",         \"nonce\":\"NONCE\",        \"signature\":\"SIGNATURE\"    },            \"body\":    {        \"token\":\"USER_TOKEN\",           \"bankInfo\":{             \"bank\":\"招商银行深圳支行\",  \"accountId\":\"1234567812345678\",     \"accountName\":\"深圳麦圈互动技术有限公司\",\"address\":\"北京八大胡同\",\"taxNo\":\"657474\",\"telephone\":\"020-12345678\"        }    }}   ")'  type="button" ></td>
	...
	<tr>
		...
		<td><input  value="投标人认证审核接口"  onclick='setbinding("/myBidder/authInfo/checkApplication","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},\"body\":{\"baseInfoCheck\":{\"bidder_id\":4,\"company_name\":{\"result\":\"OK#\",\"msg\":\"\"},\"short_name\":{\"result\":\"OK#\",\"msg\":\"\"},\"description\":{\"result\":\"OK#\",\"msg\":\"\"},\"registered_capital\":{\"result\":\"OK#\",\"msg\":\"\"},\"contact_mobile_num\":{\"result\":\"OK#\",\"msg\":\"\"},\"email\":{\"result\":\"OK#\",\"msg\":\"\"},\"logo\":{\"result\":\"OK#\",\"msg\":\"\"}},\"legalPersonCheck\":{\"legal_person\":{\"result\":\"OK#\",\"msg\":\"\"},\"legal_person_idcard\":{\"result\":\"OK#\",\"msg\":\"\"},\"legal_person_idcard_front_url\":{\"result\":\"OK#\",\"msg\":\"\"},\"legal_person_idcard_back_url\":{\"result\":\"OK#\",\"msg\":\"\"},\"legal_person_authority_book\":{\"result\":\"OK#\",\"msg\":\"\"}},\"registeredInfoCheck\":{\"business_license_url\":{\"result\":\"OK#\",\"msg\":\"\"},\"tax_registration_certificate\":{\"result\":\"OK#\",\"msg\":\"\"},\"tax_registration_certificate_url\":{\"result\":\"OK#\",\"msg\":\"\"},\"org_code_certificate\":{\"result\":\"OK#\",\"msg\":\"\"},\"org_code_certificate_url\":{\"result\":\"OK#\",\"msg\":\"\"},\"business_scope\":{\"result\":\"OK#\",\"msg\":\"\"},\"reg_time\":{\"result\":\"OK#\",\"msg\":\"\"},\"business_license_expire_time\":{\"result\":\"OK#\",\"msg\":\"\"},\"address\":{\"result\":\"OK#\",\"msg\":\"\"},\"unified_social_credit_code\":{\"result\":\"OK#\",\"msg\":\"\"},\"unified_social_credit_code_url\":{\"result\":\"OK#\",\"msg\":\"\"}},\"bankInfoCheck\":{\"bank_name\":{\"result\":\"OK#\",\"msg\":\"\"},\"account_no\":{\"result\":\"OK#\",\"msg\":\"\"},\"account_name\":{\"result\":\"OK#\",\"msg\":\"\"}},\"certificationsCheck\":[{\"certificationApplyId\":\"58\",\"certificationApply\":{\"result\":\"FLS\",\"msg\":\"证书编号没有找到\"}},{\"certificationApplyId\":\"59\",\"certificationApply\":{\"result\":\"OK#\",\"msg\":\"\"}}]}}")'  type="button" ></td>
	</tr>
	...
	<tr>
		...
		<td><input  value="查询招标项目接口"  onclick='setbinding("/tender/queryObjectList_homepage","{    \"app\":{        \"appId\":\"paas\",        \"timeStamp\":\"TIMESTAMP\",         \"nonce\":\"NONCE\",        \"signature\":\"SIGNATURE\"    },    \"body\":{        \"keywords\":[{\"keyword\":\"投标\"},{\"keyword\":\"深圳\"}]  , \"publishTime\":10,\"status\":\"PUB\",      \"pageIndex\":0,        \"pageSize\":10    }} ")'  type="button" ></td>
	...
	<tr>
		...
		<td><input  value="查询未完成招标项目投标文件"  onclick='setbinding("/bid/queryObjectFileTypeRequirementInfo","{\"app\":{\"appId\":\"zjhtwallet\",\"timeStamp\":\"TIMESTAMP\",\"nonce\":\"NONCE\",\"signature\":\"SIGNATURE\"},\"body\":{\"objectId\":\"BH2015082135656\"}}")'  type="button" ></td>
	...
	<tr>
		...
		<td><input type="button"  value="项目应付款查询"  onclick='setbinding("/myPayment/queryMyPayment","{\"app\":{\"appId\":\"paas\",\"timeStamp\":\"TIMESTAMP\",  \"nonce\":\"NONCE\", \"signature\":\"21aa0011472249b4292e81504f3917bd\"  },\"body\":{\"token\":\"96c5f0e5e3c52fa0fc632aaa30d4fb85\",\"objectId\":\"ZB0020151117160110354552525\"}}")'></td>
	</tr>
