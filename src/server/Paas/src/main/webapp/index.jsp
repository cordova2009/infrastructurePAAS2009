...
<html>
  ...
  <body>
	...
	<tr>
		...
		<td><input  value="查询投标基础信息"  onclick='setbinding("/bid/queryObjectRequirementInfo","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },                \"body\":        {          \"objectId\":\"BH2015082135656\"        }    } ")'  type="button" ></td>
