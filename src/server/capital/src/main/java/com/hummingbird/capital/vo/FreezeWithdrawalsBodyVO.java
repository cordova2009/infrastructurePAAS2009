...
public class FreezeWithdrawalsBodyVO {
	...
	public String toString() {
		return "FreezeWithdrawalsBodyVO [orderId=" + orderId + ", mobileNum=" + mobileNum +
				",tradePassword=" + tradePassword +",peerAccountUnit="+peerAccountUnit+ 
				",peerAccountId="+peerAccountId+",amount+"+amount+
				",remark="+remark+"]";
	}
