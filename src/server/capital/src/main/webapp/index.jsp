  ...
  <body>
	...
	<tr>
		...
		<td><input  value="保存投标资格审查信息接口"  onclick='setbinding("/bid/saveBidRequirementInfo"," {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },        \"body\":        {            \"token\":\"12345\",        \"objectId\":\"BH2015082135656\",        \"bidId\":1,        \"certificationList\":[{\"objReqId\":1,\"bidderCertificationId\":1},{\"objReqId\":2,\"bidderCertificationId\":2}],            \"bidSafetyInfo\":{                \"needSafetyPermitNo\":\"201562377\",                \"needSafetyPermitEndDate\":\"2015-11-21\",                \"needSafetyPermitUrl\":\"URL\",                \"needPmSafetyCertificationNo\":\"201409886432\",                \"needPmSafetyCertificationEndDate\":\"2015-09-12\",                \"needPmSafetyCertificationUrl\":\"URL\"              },            \"bidPeopleRequirement\":{                \"needPmCertificationNo\":\"20123878654\",                \"needPmCertificationEndDate\":\"2015-02-12\",                \"needPmCertificationUrl\":\"URL\",                \"needConstructorCertificationNo\":\"20150812098765\",                \"needConstructorCertificationEndDate\":\"2015-02-13\",                \"needConstructorCertificationUrl\":\"URL\"                                },            \"bankGuarantee\":{                \"bankGuaranteeAmount\":50000000,                \"bankGuaranteeUrl\":\"URL\",                \"bankGuaranteeNo\":\"BH2108765123\"            }        }    } ")'  type="button" ></td>
				<td><input  value="查询未完成投标的商务标信息接口"  onclick='setbinding("/bid/queryBusinessStandardInfo","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },        \"body\":        {            \"token\":\"12345\",            \"bidId\":\"TB201511040982\",            \"objectId\":\"BH2015082135656\"        }    } ")'  type="button" ></td>
				<td><input  value="保存投标的商务标信息接口"  onclick='setbinding("/bid/saveBusinessStandardInfo","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },        \"body\":        {            \"token\":\"12345\",            \"objectId\":\"BH2015082135656\",            \"bidId\":\"4\",            \"bidAmount\":\"5000000000\",            \"projectQuotationUrl\":\"URL\",            \"constructionStartDate\":\"2015-01-21\",            \"constructionEndDate\":\"2015-08-21\",            \"constructionCommitmentUrl\":\"URL\"        }    } ")'  type="button" ></td>
				<td><input  value="查询未完成投标的技术标信息接口"  onclick='setbinding("/bid/queryTechnicalStandardInfo","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },        \"body\":        {            \"token\":\"12345\",            \"bidId\":\"TB201511040982\",            \"objectId\":\"BH2015082135656\"        }    } ")'  type="button" ></td>
				<td><input  value="保存投标的技术标信息接口"  onclick='setbinding("/bid/saveTechnicalStandardInfo","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },        \"body\":        {            \"token\":\"12345\",            \"objectId\":\"BH2015082135656\",            \"bidId\":\"4\",            \"technicalStandardUrl\":\"URL\"        }    } ")'  type="button" ></td>
	</tr>
	<tr>
				<td><input  value="查询投标保证金信息接口"  onclick='setbinding("/bid/queryBidderBond","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },        \"body\":        {            \"token\":\"43564\",            \"bidId\":\"TB201511040982\",            \"objectId\":\"BH2015082135656\"        }    }")'  type="button" ></td>
				<td><input  value="保存投标保证金接口"  onclick='setbinding("/bid/saveBidderBond","    {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },                \"body\":        {       \"token\":\"12345\",            \"bidId\":\"TB201511040982\",            \"objectId\":\"BH2015082135656\",            \"bankGuaranteeNo\":\"327iueyr7w3\",            \"bankGuaranteeUrl\":\"http://xx.diue.com/ewdf\",            \"bankGuaranteeAmount\":\"300000\"        }    } ")'  type="button" ></td>
