...
class ObjectController extends AdminController {
	...
	public function index()
	{
		...
		$prefix = C('DB_PREFIX');
		$model = M('gcgl_project a')->join('t_ztgl_object b on a.project_id =b.object_id')->join('t_qyzz_biddee c on c.id=a.biddee_id')->join('t_qyzz_bidder d on d.id =a.bidder_id');
