        ...
        switch($type){
            ...
            case 'gcsgzm':
                ...
                $cloumn_data = [
                    ...
                    'building_construction_permit_No'=>'设工程施工许可证编号',
                ...
                $item = M('ztgl_object_project_info')
                        ...
                        ->field(array_keys($cloumn_data))
                        ->find();
                if($item['construction_prove_type'] == 'BCP'){
            ...
            case 'bzj':
                $cloumn_data = [
                    'bidder_bid_bond'=>'投标保证金额'
                ];
                $item = M('ztgl_object_bond_setting')
                        ->where($where)
                        ->field(array_keys($cloumn_data))
                        ->find();
                ...
                echo '
                    <div class="center">
                        <span class="btn btn-app btn-sm btn-yellow no-hover" style="width: auto;">
                            <span class="line-height-1 bigger-170 blue"> ￥'.price_format($item['bidder_bid_bond']).' </span>
                            <br>
            ...
            case 'ztbwjyq':
                ...
                $item['attachment_url'] = '<a href="'.$item['attachment_url'].'">下载</a>';
...
>>>>>>> 1d6b00e66df02ecc0159ae8d26b011e5cdac4d77
}