...
<div class=""> 
	...
	<tbody>
		<tr>
			...
			<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="company_name"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="company_name"> 审核不通过</span><input type="text" name="company_name_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
			<td><span style="color:#999;padding-right:8px;">公司简称:</span>{$item.short_name}</td>
			<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="short_name"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="short_name"> 审核不通过</span><input type="text" name="short_name_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
			<td><span style="color:#999;padding-right:8px;">注册资本:</span>{$item.registered_capital}</td>
			<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="registered_capital"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="registered_capital"> 审核不通过</span><input type="text" name="registered_capital_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
			<td><span style="color:#999;padding-right:8px;">联系方式:</span>{$item.contact_mobile_num}</td>
			<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="contact_mobile_num"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="contact_mobile_num"> 审核不通过</span><input type="text" name="contact_mobile_num_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
			<td><span style="color:#999;padding-right:8px;">EMail:</span>{$item.email}</td>
			<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="email"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="email"> 审核不通过</span><input type="text" name="email_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
...
<div class=""> 
	...
	<tbody>
		<tr>
			...
			<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="legal_person"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="legal_person"> 审核不通过</span><input type="text" name="legal_person_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
...
<?php }else{?>
	<tr>
		...
		<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="business_license"> 审核通过</span><input type="text" name="business_license_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
...
<?php }?>
	<tr>
		...
		<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="business_license_expire_time"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="business_license_expire_time"> 审核不通过</span><input type="text" name="business_license_expire_time_msg" placeholder="输入审核未通过原因"></td>
		</tr>
	<tr>
		<td ><span style="color:#999;padding-right:8px;">注册时间:</span><?php echo $item['reg_time']?></td>
		<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="reg_time"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="reg_time"> 审核不通过</span><input type="text" name="reg_time_msg" placeholder="输入审核未通过原因"></td>
		</tr>
	<tr>
		<td><span style="color:#999;padding-right:8px;">经营范围:</span><?php echo $item['business_scope'];?></td>
		<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="business_scope"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="business_scope"> 审核不通过</span><input type="text" name="business_scope_msg" placeholder="输入审核未通过原因"></td>
		</tr>
	<tr>
		<td ><span style="color:#999;padding-right:8px;">注册地址:</span><?php echo $item['address'];?></td>
		<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="address"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="address"> 审核不通过</span><input type="text" name="address_msg" placeholder="输入审核未通过原因"></td>
		</tr>
	 </tbody>
	</table>
</div>
...
<div class=""> 
	...
	<tbody>
		...
		<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="bank_name"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="bank_name"> 审核不通过</span><input type="text" name="bank_name_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
			<td><span style="color:#999;padding-right:8px;">银行账号:</span>{$item.account_no}</td>
		<td><span style="color:#999;padding-right:8px;"><input type="radio" value="Y" name="account_no"> 审核通过</span><span style="color:#999;padding-right:8px;"><input type="radio" value="N" name="account_no"> 审核不通过</span><input type="text" name="account_no_msg" placeholder="输入审核未通过原因"></td>
		</tr>
		<tr>
