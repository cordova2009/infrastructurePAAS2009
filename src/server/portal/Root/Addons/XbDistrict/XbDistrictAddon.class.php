 ...
 * @author xuebing
 */
class XbDistrictAddon extends Addon {
    public $info = array (
            'name' => 'XbDistrict',
            'title' => '中国省市区三四级联动',
    ...
    public function install() {
        ...
        /* 先判断插件需要的钩子是否存在 */
        $this->getisHook ( 'H_XbDistrict', $this->info ['name'], $this->info ['description'] );
    ...
    // 实现的J_China_City钩子方法
    public function H_XbDistrict($param) {
        $this->assign ( 'param', $param );
        $this->display ( 'xbdistrict' );
    }
