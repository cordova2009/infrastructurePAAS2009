...
<html>
  ...
  <body>
	...
	<tr>
		...
		<td><input  value="重置登录密码接口"  onclick='setbinding("/userSecurity/resetPassword"," {        \"app\":{            \"appId\":\"zjhtwallet\",            \"timeStamp\":\"TIMESTAMP\",             \"nonce\":\"NONCE\",            \"signature\":\"SIGNATURE\"        },        \"body\":{           \"realName\":\"张三\",           \"cardID\":\"660100198108131211\",           \"mobileNum\":\"13657256722\",       \"operator\":34        }}")'  type="button" ></td>
	</tr>
