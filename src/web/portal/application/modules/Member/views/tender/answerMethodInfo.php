    ...
    <div class="padm30">
        ...
        <div class="dayi ">
            <div class="item ">
                ...
                <div class="value">
                    <input type="text" class="input1 datepicker wid160" placeholder="" name="startTime"> 到
                    <input type="text" class="input1 datepicker wid160" placeholder="" name="endTime">
                </div>
            </div>
            ...
            <div class="table">
                ...
                <div class="cell">
                    <p class="txt">QQ群方式</p>
                    <input type="text" class="wid70 input2" name="QQ">
                    加入QQ群口令 <input type="text" class="wid70 input2" name="QQtoken">
            ...
            <div class="table">
                ...
                <div class="cell">
                    <p class="txt">邮件方式</p>
                    请发邮件到 <input type="text" class="input2 wid110" name="email">
                    <p>我们将在48小时内回复。</p>
                </div>
            </div>
            ...
            <div class="table">
                ...
                <div class="cell">
                    <p class="txt">电话方式</p>
                    请在上班时间拨打 <input type="text" class="wid130 input2" name="telephone" > 答疑
                </div>
            </div>
            ...
            <div class="table">
                ...
                <div class="cell">
                    <p class="txt">现场方式</p>
                    <div>地点
                        <input type="text" class="wid240 input2" name="address">
                    </div>
                    <div class="padt10">时间
                        <input type="text" class="input2 wid110 datepicker" name="addressAnswerDate">
                        <input type="text" placeholder ="14:00-16:30" class="input2 wid100" name="addressAnswerTime">
                    </div>
                </div>
            </div>
