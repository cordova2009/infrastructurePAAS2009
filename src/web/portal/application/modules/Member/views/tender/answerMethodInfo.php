        ...
        <div class="dayi ">
            ...
            <div class="table">
                <div class="cell checklist">
                    ...
                    <input name="answer_type[qq]" type="checkbox" class="hide" <?php if(isset($info) && !empty($info['qq'])) echo 'checked'?>>
                </div>
            ...
            <div class="table">
                <div class="cell checklist">
                    ...
                    <input name="answer_type[email]" type="checkbox" class="hide" <?php if(isset($info) && !empty($info['email'])) echo 'checked'?>>
                </div>
                <div class="cell icoCont">
            ...
            <div class="table">
                <div class="cell checklist">
                    ...
                    <input name="answer_type[phone]" type="checkbox" class="hide" <?php if(isset($info) && !empty($info['telephone'])) echo 'checked'?>>
                </div>
                <div class="cell icoCont">
                    <i class="ico i-tel"></i>
                </div>
            ...
            <div class="table">
                <div class="cell checklist">
                    ...
                    <input name="answer_type[address]" type="checkbox" class="hide" <?php if(isset($info) && !empty($info['address'])) echo 'checked'?>>
                </div>
                <div class="cell icoCont">
                    <i class="ico i-xc"></i>
                </div>
