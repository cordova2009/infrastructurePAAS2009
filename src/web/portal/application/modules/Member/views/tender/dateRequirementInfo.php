    ...
    <div class="padm30">
        ...
        <div class="shangwubiao gqyq">
            ...
            <div class="item ">
                ...
                <div class="value">
                    <input type="text" class="input1 datepicker wid160" placeholder="" name="announcementBeginTime"> 到
                    <input type="text" class="input1 datepicker wid160" placeholder="" name="announcementEndTime">
                </div>
            </div>
            <div class="item ">
                <div class="lab"><span class="red">*</span>投标截止时间</div>
                <div class="value">
                    <input type="text" class="input1 datepicker" placeholder="" name="biddingEndTime">
                </div>
            </div>
            <div class="item ">
                <div class="lab"><span class="red">*</span>开标时间</div>
                <div class="value">
                    <input type="text" class="input1 datepicker" placeholder="" name="bidOpenDate">
                </div>
            </div>
